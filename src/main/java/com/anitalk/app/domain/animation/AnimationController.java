...
public class AnimationController {
    ...
    @GetMapping
    public ResponseEntity<Page<AnimationRecord>> getAnimations(Pagination pagination){
        Page<AnimationRecord> animations = animationService.getAnimations(pagination);
